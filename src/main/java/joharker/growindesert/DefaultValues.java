...
public class DefaultValues
{
	...
	// Colorize wood in desert by dry tints
	public static final Color WOOD_COLOR_MULTIPLIER = new Color(240, 228, 186);
	
	public static class GRASS_BLOCK
	{
		public static final int SAPLING_CHANCE_WEIGHT = 8;
	}
	
	public static class DEAD_BUSH
	{
